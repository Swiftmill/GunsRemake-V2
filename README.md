...
3. **Lancer l’API + front** :
   ...
   > Remarque : même si le service est lié à `0.0.0.0` pour accepter les connexions entrantes, ouvrez bien `http://localhost:3001` dans le navigateur (l’URL `0.0.0.0` n’est pas valide côté client).
4. **Comptes de test** :
